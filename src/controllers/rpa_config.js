...
export const ZONE_BASE_LOSS_RATE = {
  "0":   0.01,   // 1%  — aléa négligeable
  "I":   0.08,   // 8%  — séisme modéré
  "IIa": 0.22,   // 22% — séisme modéré-fort
  "IIb": 0.38,   // 38% — séisme fort
  "III": 0.60,   // 60% — séisme majeur (réf. Boumerdès Mw6.8)
};

export const TYPE_VULNERABILITY = {
  "Résidentiel":   1.30,   // +30% : souvent maçonnerie non conforme
  "Commerciale":   1.15,   // +15% : construction hétérogène
  "Industrielle":  0.90,   // -10% : normes de construction plus strictes
};

// Taux de prime moyen observé sur échantillon réel (0.05%)
